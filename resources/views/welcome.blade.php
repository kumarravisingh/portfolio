            ...
            <div class="flex items-center justify-between">
                <div>
                    <a class="flex items-center text-gray-800 hover:text-indigo-600" href="#">
                        ...
                        <span class="mx-3 font-medium text-sm md:text-base">Kumar Ravi</span>
                    </a>
                </div>
                <div class="flex items-center -mx-2">
                    ...
                    @guest
                        <a class="flex items-center font-medium mx-2 text-gray-800 hover:text-indigo-600" href="{{ route('login') }}">
                        {{ __('Login') }}
                        </a>

                        @if(Route::has('register'))
                            <a class="flex items-center font-medium mx-2 text-gray-800 hover:text-indigo-600" href="{{ route('register') }}">
                                {{ __('Register') }}
                            </a>
                        @endif
                    @else
                        ...
                        <div class="w-1/4 md:w-auto md:flex text-right ml-1 cursor-pointer profile-menu z-10">
                            ...
                            <div class="hidden md:block md:flex md:items-center ml-2">
                                <span class="font-medium mx-2 text-gray-800  mr-1">{{auth()->user()->name}}</span>
                                <div class="profile-menu-arrow relative flex items-center pl-4">
