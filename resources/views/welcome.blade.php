...
@section('content')
            ...
            <div class="flex items-center justify-between">
                <div>
                    <a class="flex items-center text-gray-800 hover:text-indigo-600" href="{{url('/')}}">
                        ...
                        <span class="mx-3 font-large text-sm md:text-lg">Kumar Ravi</span>
                    </a>
                </div>
                <div class="flex items-center -mx-2">
                    <a class="flex items-center mx-2 text-gray-800 hover:text-indigo-600" target="_blank" href="https://www.linkedin.com/in/kumarravisingh/">
                        <i class="fab fa-linkedin fa-2x"></i>
                    </a>

                    <a class="flex items-center mx-2 text-gray-800 hover:text-indigo-600" target="_blank" href="https://twitter.com/kumarravi_me">
                        <i class="fab fa-twitter fa-2x"></i>
                    </a>

                    <a class="flex items-center mx-2 text-gray-800 hover:text-indigo-600" target="_blank" href="https://github.com/kumarravisingh">
                    ...
                    @else
                        ...
                        <div class="w-1/4 md:w-auto md:flex text-right ml-1 cursor-pointer profile-menu z-10">
                            <div>
    ...
    <section class="bg-gray-800 pattern py-20">
        <div class="max-w-5xl px-6 mx-auto text-center">
            ...
            <p class="text-gray-400 mt-4">
                I am a full-stack developer with more than five years experience in the laravel software development field.
                My knowledge boundaries extend to Laravel framework ecosystem and technologies such as
                VueJS, NuxtJs, Docker, AWS etc.
            </p>
        </div>
    </section>
    ...
    <section class="bg-gray-800 pattern py-20">
        <div class="max-w-5xl px-6 mx-auto text-center">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <a href="https://github.com/kumarravisingh/laravel-import-multisheet-excel-with-formula" target="_blank" class="block bg-gray-700 mt-5 rounded-md overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            <div class="py-2 px-3 text-center text-sm">
                                <p class="text-gray-300">
                                    Demo to import excel file with multiple
                                    sheet and formula using Laravel.
                                </p>


                                <span class="block text-gray-500 mt-2">Laravel Multisheet</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="max-w-xs w-full">
                        ...
                        <a href="https://github.com/kumarravisingh/laraconcountdown" target="_blank" class="block bg-gray-700 mt-5 rounded-md overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            <div class="py-2 px-3 text-center text-sm">
                                <p class="text-gray-300">Countdown application for laravel annual event</p>

                                <span class="block text-gray-500 mt-2">Laracon Countdown</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="max-w-xs w-full">
                        ...
                        <a href="https://github.com/kumarravisingh/docker-legacy" target="_blank" class="block bg-gray-700 mt-5 rounded-md overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                            <div class="py-2 px-3 text-center text-sm">
                                <p class="text-gray-300">Demo application to run different version of php using docker</p>

                                <span class="block text-gray-500 mt-2">Docker Legacy</span>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-center mt-12">
                <a class="flex items-center text-white hover:underline hover:text-gray-200" target="_blank" href="https://github.com/kumarravisingh">
    ...
    <footer class="bg-white">
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <div>
                    <div class="text-gray-600">&copy; Kumar Ravi</div>
                </div>

                <div class="flex items-center -mx-2">
                    <a class="flex items-center mx-2 text-gray-600 hover:text-indigo-600" target="_blank" href="https://www.linkedin.com/in/kumarravisingh/">
                        <i class="footer-social-icons fab fa-linkedin fa-2x"></i>
                    </a>

                    <a class="flex items-center mx-2 text-gray-600 hover:text-indigo-600" target="_blank" href="https://twitter.com/kumarravi_me">
                        <i class="footer-social-icons fab fa-twitter fa-2x"></i>
                    </a>

                    <a class="flex items-center mx-2 text-gray-600 hover:text-indigo-600" target="_blank" href="https://github.com/kumarravisingh">
                        <i class="footer-social-icons fab fa-github fa-2x"></i>
                    </a>
                </div>
            </div>
        </div>
